...
| `currentTime`        |                      |           | `number`                                                                                                                                            |                                                                                                             | Set the currentTime of playback, seeking to that time.                                                                                                                                            |
...
| `uiUpdateInterval`   | `ui-update-interval` |           | `number`                                                                                                                                            | 250                                                                                                         | How often the UI should update during playback, in milliseconds.<br />Defaults to 250ms (4 times per second). Controls both the player state<br />updates and the timeupdate event emission rate. |
